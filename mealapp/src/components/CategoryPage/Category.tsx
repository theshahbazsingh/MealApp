        ...
        <>
            <div className="grid xl:grid-cols-3 lg:grid-cols-2 sm:grid-cols-1 gap-12">
                {meals && meals.map((meal, index) => (
                    <Link href={`/meal/${meal.idMeal}`} passHref key={index}>
                        <a>
                            <div className='bg-cover bg-center mb gap-8 h-96 relative cursor-pointer hover:-translate-y-1 hover:scale-104 duration-200 shadow-md hover:shadow-lg' style={{backgroundImage:`url(${meal.strMealThumb})`}}>
